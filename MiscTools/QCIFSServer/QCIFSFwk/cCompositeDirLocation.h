...
//cCompositeDirLocation.h

#pragma once

#include "idirlocation.h"

class cCompositeDirLocation : public iDirLocation, public vfs::cRefCount
{
public:
  cCompositeDirLocation(const vfs::cPtr<iComposite> pComposite
    , const vfs::cPtr<iRename> pRename);
  ~cCompositeDirLocation(void);
