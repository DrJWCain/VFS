=========================================================================
    EXTENDED STORED PROCEDURE : QCIFSIPC Project Overview
========================================================================


AppWizard has created QCIFSIPC.dll for you.  

This file contains a summary of what you will find in each of the files that
make up your QCIFSIPC application.
...
StdAfx.h, StdAfx.cpp
    ...
    named QCIFSIPC.pch and a precompiled types file named StdAfx.obj.


/////////////////////////////////////////////////////////////////////////////
Other notes:

After completing this Wizard, copy the QCIFSIPC.dll over to your SQL Server 
\Binn directory.
...
SQL command:
  sp_addextendedproc 'xp_proc', 'QCIFSIPC.DLL'
