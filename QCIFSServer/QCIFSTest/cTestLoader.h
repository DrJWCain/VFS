...
class cTestLoader : public cChildLoader, public iCreate, public iRename, public iFileEvent, public vfs::cRefCount
{
  ...
  typedef std::map<vfs::String, vfs::cPtr<cTestLoader> > tFolderMap;
  tFolderMap FolderMap;

  vfs::String Name;
  cTestLoader* Parent;

  void cTestLoader::addVirtualFile(const vfs::String& name, const vfs::String& path);

public:
  cTestLoader(const vfs::String& name, cTestLoader* parent);
