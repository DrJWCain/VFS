...
typedef struct _SERVER_ALIAS_ENUM_STRUCT
    {
    DWORD Level;
    /* [switch_is] */ /* [switch_type] */ union SERVER_ALIAS_ENUM_UNION
        {
...
NET_API_STATUS Opnum0NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum1NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum2NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum3NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum4NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum5NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum6NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);

NET_API_STATUS Opnum7NotUsedOnWire( 
    /* [unique][string][in] */ SRVSVC_HANDLE ServerName);
